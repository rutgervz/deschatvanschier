...
export const STATUS_LABELS: Record<string, string> = {
  door_naar_slotdag: 'Door naar slotdag',
  zoekt_sleutel: 'Zoekt nog een sleutel 🗝️',
  binnen_1250: 'Binnen €1.250',
  niet_actief: 'Niet actief',
  via_anderen: 'Via anderen gerealiseerd',
  actief: 'Actief',
};

export const STATUS_STYLES: Record<string, { bg: string; fg: string }> = {
  door_naar_slotdag: { bg: '#D5F5E3', fg: '#1E8449' },
  zoekt_sleutel: { bg: '#FAEEDA', fg: '#854F0B' },
  binnen_1250: { bg: '#E1F5EE', fg: '#085041' },
  via_anderen: { bg: '#E6F1FB', fg: '#0C447C' },
};
